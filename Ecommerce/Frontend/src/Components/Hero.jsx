    ...
    return (
        <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full '>
            <div className='max_padd_container relative top-32 xs:top-52'>
                ...
                <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, sint fuga! Ex iusto repellat dolorum atque asperiores unde aspernatur. Quod eius error impedit fugit commodi? Vel, voluptatibus atque eius veritatis veniam fugit obcaecati.</p>
